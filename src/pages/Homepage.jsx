...
const Homepage = ({ blog }) => {
  useEffect(() => {
    ...
    document.querySelector('meta[property="og:url"]').setAttribute('content', "blogdarshan.netlify.app");
    ...
    document.querySelector('meta[property="twitter:url"]').setAttribute('content', "blogdarshan.netlify.app");
