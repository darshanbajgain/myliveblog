    ...
    <div className="w-full py-16 px-8 relative bg-gray-900">
      <div className="max-w-[1340px] mx-auto px-1 pt-24">
        <div className="flex flex-col items-center">
          ...
          <ReactMarkdown
            className="prose custom-prose-links  md:p-1 lg:p-2 prose-pre:mx-auto prose-pre:max-w-[250px] ss:prose-pre:max-w-full prose-headings:text-white prose-p:text-white prose-ul:text-white prose-img:max-w-[330px] prose-img:mx-auto sm:prose-img:max-w-[600px] prose-strong:text-white sm:sm:text-base md:text-lg lg:text-xl"
          >
            {markdownContent}
          </ReactMarkdown>
          <div className="flex flex-col items-center max-w-[800px] mx-auto px-8 py-6 bg-slate-800 rounded-2xl mt-16">
            <img
